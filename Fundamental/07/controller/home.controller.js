sap.ui.define([
	...
	return Controller.extend("Fundamental.controller.home", {
		...
		onPress : function() {
			if(this.oSecondPage === null)
			{
				this.oSecondPage = Helper.fnCreateAndNavTo("Fundamental.view.secondPage"); 
			}
			else
			{
				Helper.fnNavTo(this.oSecondPage);
			}
		},
		onDestroy :  function() {
			if(this.oSecondPage !== null)
			{
				this.oSecondPage.destroy();
				this.oSecondPage = null;
			}
		}
